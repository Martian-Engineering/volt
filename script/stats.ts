...
console.log("Fetching GitHub releases for anomalyco/voltcode...\n")
...
console.log("Fetching npm all-time downloads for voltcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("voltcode-ai")
