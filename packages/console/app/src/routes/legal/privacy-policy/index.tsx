...
export default function PrivacyPolicy() {
  return (
    <main data-page="legal">
      <Title>VoltCode | Privacy Policy</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/privacy-policy`} />
      <Meta name="description" content="VoltCode privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At VoltCode, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of VoltCode is at all times subject to our Terms of Use,{" "}
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the VoltCode website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about VoltCode.
                </li>
              ...
              <p>
                ...
                you, VoltCode or another party; enforcing any agreements with you; responding to claims that any posting
