...
export default function BlackLayout(props: RouteSectionProps) {
  ...
  return (
    <div data-page="black">
      <Title>VoltCode Black | Access all the world's best coding models</Title>
      <Meta
        name="description"
        content="Get access to Claude, GPT, Gemini and more with VoltCode Black subscription plans."
      />
      <Link rel="canonical" href={`${config.baseUrl}/black`} />
      <Meta property="og:type" content="website" />
      <Meta property="og:url" content={`${config.baseUrl}/black`} />
      <Meta property="og:title" content="VoltCode Black | Access all the world's best coding models" />
      <Meta
      ...
      <Meta name="twitter:title" content="VoltCode Black | Access all the world's best coding models" />
      <Meta
