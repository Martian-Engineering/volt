...
You can set the log level with the `--log-level` command-line option to get more detailed debug information. For example, `volt --log-level DEBUG`.
...
3. Ensure you have the latest version with `volt upgrade`
...
To figure out what models you have access to, run `volt models`
