...
description: What's new in VoltCode 1.0.
---

VoltCode 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same voltcode server.
...
version. However some older versions of VoltCode always grab latest.

To upgrade manually, run

```bash
$ voltcode upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ voltcode upgrade 0.15.31
```
