---
title: TUI
description: Using the VoltCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

VoltCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running VoltCode starts the TUI for the current directory.
...
When using the VoltCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to VoltCode. Allows you to select from available providers and add their API keys.
...
Exit VoltCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your VoltCode config file.
