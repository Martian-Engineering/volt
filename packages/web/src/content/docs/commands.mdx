...
Create `.voltcode/commands/test.md`:

```md title=".voltcode/commands/test.md"
---
...
You can add custom commands through the VoltCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your VoltCode [config](/docs/config):

```json title="voltcode.jsonc" {4-12}
{
...
- Global: `~/.config/voltcode/commands/`
- Per-project: `.voltcode/commands/`

```markdown title="~/.config/voltcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".voltcode/commands/component.md"
---
...
```md title=".voltcode/commands/create-file.md"
---
...
```md title=".voltcode/commands/analyze-coverage.md"
---
...
```md title=".voltcode/commands/review-changes.md"
---
...
```md title=".voltcode/commands/review-component.md"
---
...
voltcode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
