---
title: Zen
description: Curated list of models provided by VoltCode.
---
...
VoltCode Zen is a list of tested and verified models provided by the VoltCode team.

:::note
VoltCode Zen is currently in beta.
:::

Zen works like any other provider in VoltCode. You login to VoltCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with VoltCode.
:::
...
VoltCode Zen is an AI gateway that gives you access to these models.

---

## How it works

VoltCode Zen works like any other provider in VoltCode.

1. You sign in to **<a href={console}>VoltCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select VoltCode Zen, and paste your API key.
...
| Volt 0.1           | glm-4.7-free       | `https://opencode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
The [model id](/docs/config/#models) in your VoltCode config
uses the format `voltcode/<model-id>`. For example, for GPT 5.2 Codex, you would
use `voltcode/gpt-5.2-codex` in your config.
...
- Grok Code Fast 1 is currently free on VoltCode for a limited time. The xAI team is using this time to collect feedback and improve Grok Code.
- Volt 0.1 is currently free on VoltCode for a limited time. The team is using this time to collect feedback and improve the model.
- MiniMax M2.1 is currently free on VoltCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on VoltCode for a limited time. The team is using this time to collect feedback and improve the model.
...
- Volt 0.1: During its free period, collected data may be used to improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with VoltCode as well.
