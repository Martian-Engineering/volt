...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/voltcode.git")).toEqual({ owner: "sst", repo: "voltcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/voltcode")).toEqual({ owner: "sst", repo: "voltcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/voltcode.git")).toEqual({ owner: "sst", repo: "voltcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/voltcode")).toEqual({ owner: "sst", repo: "voltcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/voltcode.git")).toEqual({ owner: "sst", repo: "voltcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/voltcode")).toEqual({ owner: "sst", repo: "voltcode" })
})
