...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders VOLTCODE_CALLER", () => {
    process.env["VOLTCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode VOLTCODE_CALLER", () => {
    process.env["VOLTCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown VOLTCODE_CALLER", () => {
    process.env["VOLTCODE_CALLER"] = "unknown"
