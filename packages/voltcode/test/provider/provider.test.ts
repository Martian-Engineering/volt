...
const mockPlugin = () => ({})
mock.module("voltcode-copilot-auth", () => ({ default: mockPlugin }))
mock.module("voltcode-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/voltcode-gitlab-auth", () => ({ default: mockPlugin }))
