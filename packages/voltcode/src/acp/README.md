...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for voltcode.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal voltcode sessions
...
- **Terminal Integration**: Full terminal support via voltcode's bash tool
...
ACP sessions map cleanly to voltcode's internal session model:
