...
const TIPS = [
  ...
  "Use {highlight}volt run{/highlight} for non-interactive scripting",
  "Use {highlight}volt --continue{/highlight} to resume the last session",
  "Use {highlight}volt run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}volt serve{/highlight} for headless API access to VoltCode",
  "Use {highlight}volt run --attach{/highlight} to connect to a running server",
  "Run {highlight}volt upgrade{/highlight} to update to the latest version",
  "Run {highlight}volt auth list{/highlight} to see all configured providers",
  "Run {highlight}volt agent create{/highlight} for guided agent creation",
  "Use {highlight}/volt{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}volt github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/volt fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}volt debug config{/highlight} to troubleshoot configuration",
