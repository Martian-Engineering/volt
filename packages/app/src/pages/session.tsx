...
export default function Page() {
  ...
  createEffect(() => {
    const sessionID = params.id
    if (!sessionID) return
    const raw = sessionStorage.getItem("voltcode.pendingMessage")
    if (!raw) return
    ...
    sessionStorage.removeItem("voltcode.pendingMessage")
            ...
            <Switch>
              <Match when={params.id}>
                <Show
                  when={activeMessage()}
                  fallback={
                    <div class="h-full flex flex-col items-center justify-center text-center gap-6 pb-40">
                      <Mark class="w-14 opacity-10" />
                      <div class="text-13-regular text-text-weak max-w-56">Start a new conversation</div>
                    </div>
                  }
                >
                  <Show
                          ...
                          <For each={renderedUserMessages()}>
                            {(message, index) => {
                              ...
                              const previousMessage = createMemo(() => {
                                ...
                                return renderedUserMessages()[i - 1]
                              })
                              ...
                              return (
                                <>
                                  <SessionModeIndicator
                                    ...
                                    classes={{
                                      root: showTabs() ? "" : "md:max-w-200 md:mx-auto",
                                    }}
                                  />
                                  <div
