...
export function SessionHeader() {
  ...
  const centerMount = createMemo(() => document.getElementById("voltcode-titlebar-center"))
  const rightMount = createMemo(() => document.getElementById("voltcode-titlebar-right"))
